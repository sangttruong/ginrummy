...
public class GinRummyGame_Parallel_OHE {
	private DataCollector_Parallel_OHE dataCollector = new DataCollector_Parallel_OHE();
	private final Random RANDOM = new Random();
	private final int HAND_SIZE = 10;
	private boolean playVerbose = false;
	private GinRummyPlayer[] players;
	
	public GinRummyGame_Parallel_OHE(GinRummyPlayer player0, GinRummyPlayer player1)
	{
	...
	public DataCollector_Parallel_OHE getDataCollector()
	{
	...
	public static void parallelDataCollection(int parallelID) throws IOException{
		...
		GinRummyGame_Parallel_OHE game_demo = new GinRummyGame_Parallel_OHE(new ExperimentalPlayer(), new SimpleGinRummyPlayer());
		game_demo.setPlayVerbose(true);
		game_demo.play();
		
		// Multiple non-verbose games 
		GinRummyGame_Parallel_OHE game = new GinRummyGame_Parallel_OHE(new ExperimentalPlayer(), new SimpleGinRummyPlayer());
		...
		// Print data to file
		// String pathSang = "/Users/sangtruong_2021/Documents/GitHub/GR-Git/GR-Data/";
		// String pathHoang = "/Users/hoangpham/Documents/Java/GinRummy/GR-Data/";
		String pathAlucard = "/home/LDAPdir/struong21/GR/GinRummy/GR-Data/";
		
		FileWriter gamestates = new FileWriter (pathAlucard + "Test_gamestates_" + parallelID + ".txt");
	...
	public static void main(String[] args) throws IOException {
		...
		// String pathHoang = "/Users/hoangpham/Documents/Java/GinRummy/GR-Data/";
		String pathAlucard = "/home/LDAPdir/struong21/GR/GinRummy/GR-Data/";
		FileWriter fw_gamestates = new FileWriter(pathAlucard + "ExperimentalPlayer_June22_gamestates.txt");
		fw_gamestates.write("Player 0: ExperimentalPlayer.java\n" + 
							"Player 1: SimpleGinRummyPlayer.java\n" + 
							"10 of 1000 games, in ______ms each.\n" + 
							"Games Won: P0:______, P1:______.\n\n" + 
							"Data include: player0\n" +
							"Date: July 22, 2020\n" +
							"----------------------------------------------------------------------\n\n");
		
		for(int i = 0; i < numStream; i++)
		{
			File f_gamestates = new File(pathAlucard + "Test_gamestates_" + i + ".txt");			
