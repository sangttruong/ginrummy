 ...
 */
public class SGP_XGBGeo_Knock implements GinRummyPlayer {
...
//    private final int INIT_RATIO = 2;
	...
	public Card getDiscard() {
		...
		for (Card card: unmeldedCards)
		{
			...
			int[] _features = new int[features.size()];
			for(int i = 0; i < features.size(); i++) _features[i] = features.get(i);
			
			double predScore = XGB.score(_features) + dwTolerate*_features[178] ;
