...
public class DualInception implements GinRummyPlayer {
	...
	public Card getDiscard() {
		...
		// Discard based on offensive score
		...
		for (Card card: unmeldedCards){	
            ...
            //53. RunNum0
            int runNumber0 = (int) FeatureEngineer.run(remainingCards).get(0);
			feature.add(runNumber0);
                        
			//54. SetNum0
			int setNumber0 = (int) FeatureEngineer.set(remainingCards).get(0);
			...
			//56. Hitscore0
			int hitscore = FeatureEngineer.hitScore(remainingCards); 
...
//		Print offensive and defensive score
//		estimator.print();
