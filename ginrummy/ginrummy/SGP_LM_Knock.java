...
/**
 * 
 * DO NOT EDIT. This is the final version for SGP_LM_Knock. For data consistency purpuse, 
 * please create a copy of this file to edit if necessary.
 * 
 * This player has use linear regression as discard decision making tool.
 * It also has a different knock stratergy.
 * 
 * @author Sang T. Truong
 * @version 1.0

 */
public class SGP_LM_Knock implements GinRummyPlayer {
