 ...
 */
public class SGP_NN_Knock implements GinRummyPlayer {
	...
	private double[] NeuralNet(ArrayList<ArrayList<Integer>> features) throws IOException
	{
		File temp = File.createTempFile("features", ".txt", new File("/home/LDAPdir/struong21/GR/GinRummy/GR-TestModel/NN/"));
		FileWriter writeState = new FileWriter(temp);
		String tempName = temp.getName();
		// FileWriter writeState = new FileWriter("/home/LDAPdir/struong21/GR/GinRummy/GR-TestModel/NN/features.txt");
		...
		try 
		{
			String[] cmdarray = new String[] {
					"/bin/bash",
					"-lc",
					"python3 GR/GinRummy/GR-TestModel/NN/NN1_run_parallel.py " + tempName
					};

			File dir = new File("/home/LDAPdir/struong21");			
			Runtime.getRuntime().exec(cmdarray, null, dir).waitFor();
		}
		catch (Exception e) { }
				
		File q_value_file = new File("/home/LDAPdir/struong21/GR/GinRummy/GR-TestModel/NN/" + "q_value_" + tempName);
		// File q_value_file = new File("/home/LDAPdir/struong21/GR/GinRummy/GR-TestModel/NN/q_value.txt");
