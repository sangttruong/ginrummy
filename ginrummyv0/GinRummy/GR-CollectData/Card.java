 ...
 * 
 * Update in version 2.0: Change getCard(int id) to public so that it's visible in from other packages.
...
public class Card implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4038254023365155556L;
