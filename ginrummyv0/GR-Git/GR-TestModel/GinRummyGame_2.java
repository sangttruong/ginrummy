...
public class GinRummyGame_2 {
	...
	public static void setPlayVerbose(boolean playVerbose) {
		GinRummyGame_2.playVerbose = playVerbose;
	}
	 ...
	 */
	public GinRummyGame_2(GinRummyPlayer player0, GinRummyPlayer player1) {
	...
	public static void main(String[] args) {
		...
		setPlayVerbose(true);
		new GinRummyGame_2(new SGP_LM5_Knock_Q(), new SimpleGinRummyPlayer()).play();
		...
		GinRummyGame_2 game = new GinRummyGame_2(new SGP_LM5_Knock_Q(), new SimpleGinRummyPlayer());
