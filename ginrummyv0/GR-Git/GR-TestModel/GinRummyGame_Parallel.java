...
//					dataCollector.addProb0();
	...
	public static int parallelDataCollection(int parallelID) throws IOException{
		// Single verbose demonstration game
		GinRummyGame_Parallel game_demo = new GinRummyGame_Parallel(new SGP_NN_Knock_server(), new SimpleGinRummyPlayer());
		game_demo.setPlayVerbose(true);
		game_demo.play();
		
		// Multiple non-verbose games 
		GinRummyGame_Parallel game = new GinRummyGame_Parallel(new SGP_NN_Knock_server(), new SimpleGinRummyPlayer());
...
//		System.out.println("Win Rate of 0: " + Arrays.toString(winRate0));
