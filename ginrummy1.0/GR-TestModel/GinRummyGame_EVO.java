...
/**
 * A game environemnt for evolutionary learning. 
 * 
 * @author Sang T. Truong
 * @version 1.0
 */
public class GinRummyGame_EVO {
	
	/**
	 * Random number generator
	 */
	private static final Random RANDOM = new Random(26);
	...
	public static void setPlayVerbose(boolean playVerbose) {
		GinRummyGame_EVO.playVerbose = playVerbose;
	}
	 ...
	 */
	public GinRummyGame_EVO(GinRummyPlayer player0, GinRummyPlayer player1) {
	...
	public static void main(String[] args) {		
		...
		setPlayVerbose(true);
		new GinRummyGame_EVO(new SGP_LM5_Knock_EVO(), new SGP_LM5_Knock_EVO()).play();
...
//		System.out.println("Hitscore coeff before: " + SGP_LM_DrawKnock.getCoeff());
		...
		for(int j = 0; j < nGames; j++)
		{
			...
			GinRummyGame_EVO game = new GinRummyGame_EVO(player0, player1);
