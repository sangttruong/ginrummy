 ...
 */
public class SGP_LMGeo_Knock_OHE implements GinRummyPlayer {
	...
	private HandEstimator estimator = new HandEstimator();
...
//		 System.out.println(">>>>>>>>>>>unmeldedCards: " + unmeldedCards);
		...
		// Guess what opponent is looking for (hitscore card) ----------------------------------------------------------------------
		ArrayList<Card> estHand1 = estimator.getEstimatedHand();
//		System.out.println(">>>>>>>>>>>getEstimatedHand: " + estHand1);
		
		ArrayList<Card> estHitscoreCard1 = (ArrayList<Card>) FeatureEngineer0.hitScore_(estHand1).get(1);
//		ArrayList<Card> unmeldedCards_1notNeed = new ArrayList<Card>();
//		for (Card card: unmeldedCards)
//			if (!estHitscoreCard1.contains(card)) unmeldedCards_1notNeed.add(card);
//		if (unmeldedCards_1notNeed.size() == 0)
//			unmeldedCards_1notNeed = (ArrayList<Card>) unmeldedCards.clone();
//		
//		System.out.println(">>>>>>>>>>>unmeldedCards_1notNeed: " + unmeldedCards_1notNeed);
...
//			System.out.println(">>>>>>>>>>>>>> Score: " + predScore);
			...
			if (estHitscoreCard1.contains(card)) predScore = predScore - dwTolerate;
   ...
   @SuppressWarnings("unchecked")
	...
	public ArrayList<ArrayList<Card>> getFinalMelds() {
        ...
        else
        {
        	...
        	else if (deadwoodPoints >= 1) return null; //Choose not to knock
        	else return bestMeldSets.get(random.nextInt(bestMeldSets.size()));
        }
	}
