 ...
 */
public class SimpleGinRummyPlayer_Debug implements GinRummyPlayer {
	...
	public Card getDiscard() {
		...
		for (Card card : cards) {
			...
			// Debug: Disallow repeat of draw and discard----------------------------------------------------------------------------------------------------------------------------------------------------------------
//			System.out.println(">>>>>>> Card that is considering: " + card);
//			
//			System.out.println("Disallow repeat of draw and discard: " 
//								+ drawDiscardBitstrings
//								+ drawDiscard
//								+ drawDiscardBitstrings.contains(GinRummyUtil.cardsToBitstring(drawDiscard)));
//			System.out.println("This is drawDiscardBitstrings: ");
//			for(long bitstring: drawDiscardBitstrings)
//				System.out.println(GinRummyUtil.bitstringToCards(bitstring));
			//----------------------------------------------------------------------------------------------------------------------------------------------------------------
		...
		// Debug: Candidate card---------------------------------------------------------------------------------------------------------------------------------------------------------------
		System.out.println(">>>>>> Candidate card: " + candidateCards);
//		System.out.println(candidateCards.size());
//		System.out.println(random.nextInt(candidateCards.size()));
		//----------------------------------------------------------------------------------------------------------------------------------------------------------------
